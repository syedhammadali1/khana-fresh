...
@section('wrapper')
    ...
    <form class="row g-3" action="{{ route('terms.update', $term) }}" method="POST">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-center">
                            <h5 class="mb-0 text-primary">Edit Term</h5>
                        </div>
                        <hr>
                        <div class="col-md-12">
                            ...
                            <textarea name="condition"  class="form-control @error('condition') is-invalid @enderror"
                                id="condition" id="" cols="10" rows="7">{{ $term->condition }}</textarea>
                            @error('condition')
