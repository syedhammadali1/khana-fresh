<div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="table table-striped table-inverse table-responsive">
                <table class="table mb-0 align-middle">
                    <thead class="table-light">
                        <tr>
                            <th class="form-label h3 text-primary text-center">Old Stock</th>
                            <th class="form-label h3 text-primary text-center">Added Stock</th>
                            <th class="form-label h3 text-primary text-center">Sold Stock</th>
                            <th class="form-label h3 text-primary text-center">Date</th>
                        </tr>
                    </thead>
                    <tbody wire:loading.class="opacity-50">
                        ...
                        @forelse ($list as $key => $item)
                            <tr>
                                <td class="h5 text-center"> {{ $item->old_stock }}</td>
                                <td class="h5 text-center">{{ $item->added_stock }}</td>
                                <td class="h5 text-center">
                                    {{ $item->sold_stock ?? 'Will be calculated until new stock is added' }}</td>
                                <td class="h5 text-center"> {{ date('d-F-y', strtotime($item->created_at)) }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5">
