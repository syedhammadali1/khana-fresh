        ...
        <div class="card-body">
            ...
            <div class="d-lg-flex align-items-center mb-4 gap-3">
                <div class="position-relative">
                    <form action="{{ route('ingredients.index') }}">
                ...
                <div class="ms-auto">
                    <a href="{{ route('ingredients.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        ...
                                        <form id="delete"
                                        action="{{ route('ingredients.destroy', $item) }}" method="post">
                                        @method('delete')
                                        @csrf
                                        <button class="ms-3">
