...
@section('wrapper')
    ...
    <form class="row g-3" action="{{ route('zips.update', $zip) }}" method="POST">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title d-flex align-items-center">
                            <h5 class="mb-0 text-primary">Edit Zips</h5>
                        </div>
                        <hr>
                        <div class="col-md-12">
                            <label for="name" class="form-label">Name</label>
                            <input type="text" name="zip_name" value="{{ $zip->zip_name }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" name="name" value="{{ $zip->name }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" step="any" name=" tax_rate" value="{{ $zip->tax_rate }}"
